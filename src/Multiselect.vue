                    ...
                    <span
                      ...
                      class="multiselect__option">
                        <slot name="option" :option="option" :search="search" :index="index">
                          <div v-if="withCheckbox" class="multiselect__checkbox__parent">
                            <input
                              type="checkbox"
                              class="multiselect__checkbox__input"
                          ...
                          <span v-else class="multiselect__item">{{ getOptionLabel(option) }}</span>
                        </slot>
                    </span>
                  </slidable>
                  <span
...
.multiselect__checkbox__input {
  position: absolute;
  z-index: 2;
}
.multiselect__checkbox__parent {
  display: flex;
  align-items: center;
}
.multiselect__item {
...
.multiselect__checkbox__parent .multiselect__item{
  padding-left: 20px;
}
</style>
